// dataset: iris
d3.csv('data/gene_table.csv').then(
	function(data) {
        ...
        div.each(function() {
            ...
            const cells = rows.enter().append('tr')
                .on('mouseover', function(d,i) { 
                    ...
                    $('#image_place_BSF').prepend('<img class="img-responsive" style="padding-top: 5px" id="theImg" src="images/fig_utr_heatmap_B/'+d.Gene_Id+'_coverage.png" />')
                    $('#image_place_PCF img').remove();
                    $('#image_place_PCF').prepend('<img class="img-responsive" style="padding-top: 5px" id="theImg" src="images/fig_utr_heatmap_G/'+d.Gene_Id+'_coverage.png" />')
